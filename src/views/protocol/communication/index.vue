  ...
  <div class="container">
    ...
    <el-card>
      <el-table :data="tableData" class="table" border>
        ...
        <el-table-column align="center" prop="protocalName" label="协议名称"/>

        <el-table-column align="center" prop="protocalCode" label="代号"/>
...
import { GetList, Delete } from '@/api/protocol/communication'
